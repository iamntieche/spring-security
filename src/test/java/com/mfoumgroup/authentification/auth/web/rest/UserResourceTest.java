...
public class UserResourceTest {
    ...
    private static final String UPDATED_LASTNAME = "mfoumLastName";
    ...
    void updateUserExistingEmail() throws Exception {
        ...
        anotherUser.setLogin("mfoumgroup");
        anotherUser.setPassword(RandomStringUtils.random(60));
        anotherUser.setActivated(true);
        anotherUser.setEmail("mfoumgroup@localhost");
        anotherUser.setFirstName("java");
        anotherUser.setLastName("mfoumgroup");
        ...
        managedUserVM.setEmail("mfoumgroup@localhost"); // this email should already be used by anotherUser
        managedUserVM.setActivated(updatedUser.getActivated());
    ...
    void updateUserExistingLogin() throws Exception {
        ...
        ManagedUserVM managedUserVM = new ManagedUserVM();
        managedUserVM.setId(updatedUser.getId());
        managedUserVM.setLogin("mfoumgroup"); // this login should already be used by anotherUser
        managedUserVM.setPassword(updatedUser.getPassword());
        managedUserVM.setFirstName(updatedUser.getFirstName());
        managedUserVM.setLastName(updatedUser.getLastName());
